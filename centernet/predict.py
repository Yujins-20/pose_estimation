...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "/content/drive/MyDrive/split_test"
    dir_save_path   = "/content/drive/MyDrive/centernet-tf2-main-20220719T121658Z-001/centernet-tf2-main/img/img_out"
    #-------------------------------------------------------------------------#
